    ...
    <div class="page program">
      ...
      <div class="content">
        <div class="block" v-for="(program, i) in programs" :key="i">
          <h2 class="subtitle">{{ program.date }}</h2>
          <div class="program-list">
            <div class="program-list-item" v-for="(item, i) in program.schedule" :key="i">
              <div class="card">
                <div class="card-time" v-if="item.time">
                  <font-awesome-icon icon="clock" />
                  <span>{{ item.time }}</span>
                </div>
                <div class="card-chair" v-if="item.chair">
                  <font-awesome-icon icon="chair" />
                  <span>{{ item.chair }}</span>
                </div>
                <div class="card-speaker" v-if="item.speaker">
                ...
                <!-- faClock, faFileAlt, faMapMarkerAlt, faUser, faChair -->
              </div>
              <hr>
            </div>
          </div>
        ...
        programs: [
          {
            ...
            schedule: [
              ...
              { time: '11:00 - Break' },
              { time: '11:15-12:45 | First Sessions', chair: 'Zeynep Burak', location: 'Demir Demirgil Auditorium' },
              ...
              { time: '17:00-18:00 | Second Sessions', chair: 'Yiğit Kasal', location: 'Demir Demirgil Auditorium' },
              ...
              { time: '18:00 | Boğaziçi University Music Club Classical Music Choir Concert', location: 'Demir Demirgil Auditorium' }
            ]
          },
          {
            date: 'February 16',
            schedule: [
              ...
              { time: '11:00 - Break' },
              { time: '11:15-12:45 | First Sessions', chair: 'Furkan Atmaca', location: 'Demir Demirgil Auditorium' },
              ...
              { time: '15:00-16:30 | Second Sessions', chair: 'Gökçe Güneyi', location: 'Demir Demirgil Auditorium' },
              ...
              { time: '16:00 | Closing Remarks', location: 'Demir Demirgil Auditorium' },
              { time: '19:00 | Social Get-Together' },
