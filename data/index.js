export default {
  programs: [
    {
      date: 'February 22',
      location: 'İbrahim Bodur Auditorium, Natuk Birkan Building, South Campus, Boğaziçi University, Bebek, 34342',
      schedule: [
        ...
        { time: '13:30', title: 'Poster / Minitalk Session' },
        { time: '15:00', title: 'Workshop on Designing a Minimal Linguistics Experiment with IbexFarm' },
        // { time: '15:30', title: 'Break' },
        { time: '16:30-17:30', title: 'Second Session', chair: 'TBA' },
        { time: '16:30', title: 'Swarm-alternations as degree constructions: experimental evidence', speaker: 'Lucia Vlášková' },
      ]
    },
    {
      date: 'February 23',
      ...
      schedule: [
        ...
        { time: '16:30', title: '(A)symmetrical superiority in Russian multiple wh-questions: quantitative study', speaker: 'Kseniia Studenikina' },
